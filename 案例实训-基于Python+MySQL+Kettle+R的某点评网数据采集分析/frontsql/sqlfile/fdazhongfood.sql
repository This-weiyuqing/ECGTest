...
# Date: 2019-04-24 15:16:51
# Generator: MySQL-Front 6.1  (Build 1.26)


#
# Structure for table "dazhonginfo"
#

CREATE TABLE `dazhonginfo` (
  ...
  `shopUrl` varchar(255) DEFAULT NULL COMMENT '商铺URL地址',
  `defaultPic` varchar(255) DEFAULT NULL COMMENT '商铺图片',
  PRIMARY KEY (`Id`),
